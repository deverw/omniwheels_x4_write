...
The application has been developed in Python with the [Fischertechnik ROBO Pro Coding](https://www.fischertechnik.de/en/apps-and-software) tool. Export repository as *.zip file and rename to *.ft in order to edit in ROBO Pro Coding and upload to target.
